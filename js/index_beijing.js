...
$.get('./json/beijing.json', function (geoJson) {
    ...
    myChart.setOption(option = {
        title: {
            text: '北京市新冠状病毒实时疫情数据(2020-02-04 09:28(北京时间))',
            subtext: '数据来自丁香医生',
...
function parseToCity() {
  let cityList = myData[11].cities;    //  “11”代表丁香园统计数据中beijing的实时序号
  let cityListLength = cityList.length;
  let resultdata = [];
  for (let i = 0; i < cityListLength; i++) {
    let city = {name:"",value:""};
    city.name = cityList[i].cityName;
